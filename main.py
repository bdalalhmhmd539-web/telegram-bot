...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        "هذا البوت أداة تقنية مخصصة للتنزيل فقط، ويتحمل المستخدم وحده المسؤولية الشريعة والقانونية عن نوعية المحتوى الذي يقوم بتحميله."
    )
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # إرسال الإشعار والآيدي التلقائي للأدمن
...
async def download_and_send(update: Update, context: ContextTypes.DEFAULT_TYPE, url: str, is_hd: bool = False):
    ...
    # تحديد الحد الأقصى بـ 150 ميجابايت بدقة
    ...
    try:
        ...
        # فحص صمام الأمان بحجم 150 ميجابايت
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "vip_info":
        vip_text = (
            ...
            "💳 **طرق الدفع والتفعيل:**\n"
            "1️⃣ **عبر تطبيق بنكك (Bankak):**\n"
            f"• رقم الحساب: `{BANKAK_ACCOUNT}`\n"
            f"• الاسم: **{BANKAK_NAME}**\n"
            f"• المبلغ: **{BANKAK_PRICE}**\n"
            "📸 **التفعيل:** قم بتحويل المبلغ، ثم **أرسل صورة الإشعار هنا فقط في الشات** وسيتم التفعيل فوراً!\n\n"
            "2️⃣ **عبر نجوم تلجرام (Telegram Stars):**\n"
...
def main():
    update_ytdlp() # تحديث المكتبة عند كل تشغيل تلقائياً
    ...
    print("🚀 البوت يعمل وجاهز بكافة التحسينات الشرعية والتقنية...")
    app_bot.run_polling()
