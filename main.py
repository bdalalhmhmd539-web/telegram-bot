...
ADMIN_USERNAME = "@bdalalhm" # يوزر الآدمن
ADMIN_ID = 7752459 # آيدي الآدمن لإدارة العضويات
...
def main():
    ...
    app_bot.add_handler(CommandHandler("addvip", add_vip)) # إضافة أمر الترقية هنا
